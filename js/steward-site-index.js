...
(function initStewardSiteIndex(global) {
  ...
  const PAGE_REGISTRY = {
    ...
    "schedule.html": {
      ...
      path: "schedule.html",
      section: "Main",
      summary: "Build the monthly squadron meeting schedule with uniforms and training nights; print and export PDF.",
      primaryActions: [
    ...
    "orgchart.html": {
      ...
      primaryActions: ["Add position", "View vacancies", "Print Org Chart", "Export Org Chart PDF", "Ask Steward"],
      forms: ["orgPositionForm"],
      buttons: ["Add", "Vacancies", "Steward", "Print Org Chart", "Export Org Chart PDF"],

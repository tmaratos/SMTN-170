...
(function initStewardSiteIndex(global) {
  ...
  const KEYWORD_ROUTES = [
    ...
    { patterns: [/powerpoint\s+template/i, /\bpptx?\b/i, /memorandum\s+template/i, /memo\s+template/i, /word\s+template/i, /\bdocx?\b/i, /briefing\s+template/i, /meeting\s+briefing\s+template/i, /safety\s+briefing\s+template/i, /letterhead\s+template/i, /squadron\s+templates?/i, /download\s+(a\s+)?template/i, /template\s+download/i], target: "resources.html", label: "Squadron Templates" },

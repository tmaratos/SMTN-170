...
(function initStewardSiteIndex(global) {
  ...
  const PAGE_REGISTRY = {
    ...
    "resources.html": {
      ...
      path: "resources.html",
      section: "Main",
      summary: "Curated direct links to official Civil Air Patrol publications, regulations, forms, and operational pages.",
      primaryActions: ["Open CAP publications", "Open eServices", "Open regulations"],
      forms: [],
      buttons: ["Open link", "Open CAP search"],

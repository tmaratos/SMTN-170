const { buildCapSearchUrl, buildCapGuidance, isCapGuidanceRequest, CAP_SOURCE, CAP_EXTRA_DISCLAIMER } = (() => {
  const CAP_SOURCE = "Source: Official CAP Website";
  const CAP_EXTRA_DISCLAIMER =
  ...
  function isCapGuidanceRequest(text, activeMode) {
  ...
  function buildCapGuidance(userText) {
  ...
  return { buildCapSearchUrl, buildCapGuidance, isCapGuidanceRequest, CAP_SOURCE, CAP_EXTRA_DISCLAIMER };
})();

module.exports = { buildCapSearchUrl, buildCapGuidance, isCapGuidanceRequest, CAP_SOURCE, CAP_EXTRA_DISCLAIMER };

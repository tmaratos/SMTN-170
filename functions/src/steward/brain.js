...
const INTENTS: { id; patterns: RegExp[] }[] = [
...
function buildParams(actionId, text): Record<string, unknown> {
...
function formatCapReply(cap: ReturnType<typeof buildCapGuidance>) {
  return {
    reply: cap.text + "\n\n" + cap.source + "\n\n" + DISCLAIMER,

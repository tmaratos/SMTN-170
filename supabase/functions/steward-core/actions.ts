...
function quoteTitle(text: string, max = 60) {
...
export function extractAfterCreateTask(text: string) {
  const m = text.match(/create\s+(?:a\s+)?task\s+(?:to\s+)?(.+?)(?:\.|$)/i);
  return m ? m[1].trim() : "";
}
export function extractPositionTitle(text: string) {
  const m = text.match(/(?:vacant\s+)?(.+?)\s+position/i);
  if (m) return m[1].trim();
  const m2 = text.match(/add\s+(?:vacant\s+)?(.+?)(?:\s+to|\s+in|$)/i);
  return m2 ? m2[1].trim() : "";
}
export function extractDepartment(text: string) {
...
async function logAudit(ctx: Ctx, action: string, targetTable: string | null, targetId: string | null, details: Record<string, unknown>) {
...
async function touchRow(ctx: Ctx, table: string, id: string, patch: Record<string, unknown>) {
...
export function needsConfirmation(level: RiskLevel) {
  return level === RISK.SENSITIVE_WRITE || level === RISK.DESTRUCTIVE;
}

export async function executeAction(ctx: Ctx, actionId: string, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
  ...
  const handlers: Record<string, (p: Record<string, unknown>, t: string) => Promise<ActionResult>> = {
...
async function listMeetings(ctx: Ctx, upcoming: boolean): Promise<ActionResult> {
...
async function createMeetingDraft(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function updateMeetingNotes(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
...
async function draftAgenda(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function listTasks(ctx: Ctx): Promise<ActionResult> {
...
async function createTask(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function markTaskComplete(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function listFlightReviews(ctx: Ctx): Promise<ActionResult> {
...
async function createFlightReview(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function updateFlightStatus(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function listInspection(ctx: Ctx): Promise<ActionResult> {
...
async function createInspection(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function markInspectionComplete(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function listOrg(ctx: Ctx): Promise<ActionResult> {
...
async function createVacant(ctx: Ctx, params: Record<string, unknown>, userText: string): Promise<ActionResult> {
...
async function assignOrg(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function listFiles(ctx: Ctx): Promise<ActionResult> {
...
async function categorizeFile(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function renameFile(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function deleteFile(ctx: Ctx, params: Record<string, unknown>): Promise<ActionResult> {
  const id = String(params.id || "");
...
async function showProfile(ctx: Ctx): Promise<ActionResult> {
...
function helpCapabilities(): Promise<ActionResult> {
...
export function formatActionReply(result: ActionResult): string {
...
export async function enrichParams(ctx: Ctx, actionId: string, params: Record<string, unknown>, userText: string) {
